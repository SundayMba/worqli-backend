...
namespace Servika.Infrastructure.Migrations
{
    ...
    [Migration("20260911233923_AddTransactionFees")]
    partial class AddTransactionFees
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Servika.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.Property<string>("CompletionReceiptKey")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Servika.Domain.Bookings.CustomerRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Servika.Domain.Catalogue.ArtisanKyc", b =>
                {
                    ...
                    b.Property<string>("OpenReasonCode")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("PoseSelfiesJson")
                        .HasColumnType("jsonb");

                    b.Property<int>("ResubmissionCount")
                        .HasColumnType("integer");

                    b.Property<DateTimeOffset?>("ResubmittedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Servika.Domain.Catalogue.ArtisanProfile", b =>
                {
                    ...
                    b.Property<bool>("GuarantorsWaived")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTimeOffset?>("NinLookupAttemptsDayUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("NinLookupAttemptsToday")
                        .HasColumnType("integer");

                    b.Property<DateTimeOffset?>("NinLookupCheckedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("NinLookupName")
                        .HasColumnType("text");

                    b.Property<string>("NinLookupNumber")
                        .HasColumnType("text");

                    b.Property<string>("NinLookupStatus")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Servika.Domain.Catalogue.VerificationEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Servika.Domain.Payments.Payment", b =>
                {
                    ...
                    b.Property<int?>("GatewayFeeNaira")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ServiceFeeNaira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Servika.Domain.Settings.PlatformSettings", b =>
                {
                    ...
                    b.Property<int>("CardFeeCapNaira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2000);

                    b.Property<int>("CardFeeFlatFromNaira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2500);

                    b.Property<int>("CardFeeFlatNaira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(100);

                    b.Property<decimal>("CardFeeRate")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 4)
                        .HasColumnType("numeric(5,4)")
                    ...
                    b.Property<DateTimeOffset?>("FeeNoticeSentAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("FeeNoticeStage")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<DateTimeOffset?>("FeesStartAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("RequireGuarantors")
                        .HasColumnType("boolean");

                    b.Property<int>("RequiredGuarantorCount")
                        .HasColumnType("integer");

                    b.Property<int>("TransferFeeTier1MaxNaira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(5000);

                    b.Property<int>("TransferFeeTier1Naira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(10);

                    b.Property<int>("TransferFeeTier2MaxNaira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(50000);

                    b.Property<int>("TransferFeeTier2Naira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(25);

                    b.Property<int>("TransferFeeTier3Naira")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(50);
            ...
            modelBuilder.Entity("Servika.Domain.Catalogue.VerificationEvent", b =>
                {
                    b.HasOne("Servika.Domain.Catalogue.ArtisanKyc", null)
                        .WithMany()
                        .HasForeignKey("KycId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
