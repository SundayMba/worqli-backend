...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<SetPayoutAccountHandler>();
        services.AddScoped<SetWorkPreferencesHandler>();
        services.AddScoped<SetAwayHandler>();
        services.AddScoped<ListGuarantorsHandler>();
        services.AddScoped<AddGuarantorHandler>();
        services.AddScoped<RemoveGuarantorHandler>();
        ...
        services.AddScoped<Payments.HandleRefundWebhookHandler>();
        services.AddScoped<Payments.GetBanksHandler>();
        services.AddScoped<Payments.BankAccountResolver>();
        services.AddScoped<Payments.ResolveBankAccountHandler>();
        ...
        services.AddScoped<Payments.PaymentSettlementService>();
        services.AddScoped<Payments.VerifyPaymentHandler>();
        ...
        services.AddScoped<Admin.SetGuarantorWaiverHandler>();
